...
export default function HomePage() {
    ...
    // Clear active project when landing here. Otherwise the Header keeps
    // showing the previous project's name and nav after the user navigates back.
    useEffect(() => {
        setCurrentProject(null)
    }, [setCurrentProject])

    const sortedProjects = Object.values(knownProjects).sort((a, b) => b.joinedAt - a.joinedAt)
    ...
    async function handleCreate() {
        ...
        setBusy(true)
        try {
            const project = await createProject(newProjectName.trim(), displayName.trim())
    ...
    function handleOpenProject(id: string) {
        // setCurrentProject is called inside ProjectGuard too, but doing it here
        // means the header updates immediately rather than after navigation.
    ...
    return (
        <div className="max-w-2xl mx-auto p-8">
            ...
            <p className="text-sm text-gray-500 mb-6">
                Projects are shared workspaces. Create one to get an invite link, or open one
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">
                                Just for showing who edited what. Not verified.
                            </p>
                        </div>
                        {error && (
